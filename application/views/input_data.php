...
<html lang="en">
  ...
  <form action="<?= base_url(). 'index.php/tiket/tambah_aksi'; ?>" 
    ...
    <label>Pilih Kelas         : </label><label for="kelas"><input type="radio" name="kelas" id="kelas" value="Eksekutif"> Eksekutif </label>
                            </label><label for="kelas"><input type="radio" name="kelas" id="kelas" value="Bisnis"> Bisnis </label>
                            </label><label for="kelas"><input type="radio" name="kelas" id="kelas" value="Ekonomi"> Ekonomi </label>
    ...
    <input type="submit" name="sumbit" value="Simpan"/> <input type="reset" value="Batal" /> <?= anchor('tiket/index', '<input type="button" value="Kembali" class="kembali-1"/>');?><br>
    =====================================================
    </pre> 
  </form>
 </body>
